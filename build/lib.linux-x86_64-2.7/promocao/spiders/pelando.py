...
class GatrySpider(scrapy.Spider):
	...
	def parse(self, response):
		promocoes_url = response.xpath('//div[contains(@class,"fGrid-last2")]/article[contains(@id,"thread_")]//strong/a[contains(@href,"oferta")]')
	...
	def parse_contents(self, response):
		...
		obs = promocao.xpath('//div[contains(@class,"cept-thread-content page2")]//div[contains(@class,"userHtml")]')
